package mongoutils.annotations;
...
public @interface Pojo {
    ...
    /**
     * Indicates which collection of the given {@link mongoutils.datastore.Datastore}
     * the given POJO will be placed in unless explicitly stated (i.e.
     * {@link mongoutils.datastore.Datastore#save(String, Object)} instead
     * of {@link mongoutils.datastore.Datastore#save(String, Object)}).
     *
